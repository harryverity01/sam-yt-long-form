# THE PAPER EDIT. You rewrite this file for every shoot.
#
# What is below is a real worked example, from a 1:42 group call cut to 41 minutes.
# Keep the constants. Replace BODY, COLD_OPEN, TRAILER and the DROPS with your own.
#
# All times are SOURCE seconds in src/source.mov.
